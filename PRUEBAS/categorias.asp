    ...
    While Not RS.EOF
      ...
      if cont.eof then
        ...
        if ( cont(0) >0) then
            ...
            response.write "<A class=blanco HREF='categorias.asp?id="&RS("id")& "' onMouseOver=linkOver('items"&pos&"','categorias.asp?id="&RS("id")& "','"&rs("descripcion")&"')>"&rs("descripcion")&" "&pos&"</A></div>"
